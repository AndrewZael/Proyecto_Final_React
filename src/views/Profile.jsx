...
const Profile = () => {
  ...
  return (
    <main>
       <HeadPage title={`¡Hola! ${user.username}`} subtitle='Bienvenido/a a tu perfil personal. Aquí puedes ver y administrar tus datos personales, tus publicaciones y favoritos.' />
